...
<div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl shadow-2xl p-8 auth-card">
        ...
        <form method="POST" class="space-y-4">
            ...
            <button type="submit" 
                    class="w-full bg-indigo-600 text-white py-3 rounded-xl font-bold hover:bg-indigo-700 transition shadow-lg hover:shadow-xl auth-submit">
    ...
    <p class="text-center text-indigo-100 text-xs mt-6">
        © <?php echo date('Y'); ?> Allan Shop Payroll System. All rights reserved.
    </p>
</div>
